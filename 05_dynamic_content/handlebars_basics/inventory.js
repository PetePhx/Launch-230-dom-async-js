...
(function () {
  inventory = {
    ...
    setDate: function () {
      ...
      $('#order_date').text(date.match(/^\w\w\w \w\w\w \d\d \d\d\d\d/)[0]); // ddd mmm dd yyyy
    },
    cacheTemplate: function () {
      // this.template = $('#inventory_item').html();
      this.templateItem = Handlebars.compile($('#inventory_item').html());
    ...
    addItem: function (e) {
      ...
      $('#inventory').append(this.templateItem(obj));
